        ...
        <div class="inner">
          ...
          <div v-if="showUpload">
            ...
            <Hint style="margin-top: 10px">
              To send multiple files, select one after another.
            </Hint>
          </div>
          <div v-if="fileInputArr.length && showUpload" style="margin-top: 10px">
            (selected {{fileInputArr.length}} {{fileInputArr.length === 1 ? 'file' : 'files'}})
